            ...
            <li class="dropdown dropdown-list-toggle">
                @if(auth()->user()->role == 'rektor')
                    ...
                    <div class="dropdown-menu dropdown-list dropdown-menu-right">
                        ...
                        <div class="dropdown-list-content dropdown-list-icons" style="height: auto">
                            <a href="/daftar-agenda" class="dropdown-item dropdown-item-unread">
                                ...
                                @if($data['total'] != 0)
                                    <div class="dropdown-item-desc">
                                        Terdapat {{ $data['total'] }} agenda baru, diperlukan tindakan konfirmasi.
                            ...
                            <a href="/dosen" class="dropdown-item dropdown-item-unread">
                                <div class="dropdown-item-icon bg-primary text-white">
                                ...
                                @else
                                    <div class="dropdown-item-desc">
                                        Belum ada Laporan mengenai Dosen
                                    </div>
                                @endif
                            </a>
                        </div>
                ...
                @else
                    ...
                    <div class="dropdown-menu dropdown-list dropdown-menu-right">
                        ...
                        <div class="dropdown-footer text-center">
                        <a href="/dosen">Lihat Dosen <i class="fas fa-chevron-right"></i></a>
                        </div>
                    </div>
                @endif
            </li>
